          ...
          <div class="flex flex-col lg:flex-row justify-between">
            <div class="flex flex-col items-start w-2/3 mr-5 mb-2">
              <div
                ...
                *ngIf="
                  form.controls['newTask.title']?.invalid && clickedCreateButton
                "
              >
                Title required
              </div>
          ...
          <div class="flex flex-col justify-around mt-10">
            ...
            <div class="flex justify-around w-full">
              <div
                ...
                [ngClass]="
                  newTask.priority === 'high' ? 'bg-red-700 border-red-700' : ''
                "
...
export class AddTaskComponent {
  ...
  newTask = {
    ...
    description: '',
    priority: '',
    createdTime: this.timestamp.getIsoDateFromTimestamp(this.currentTime),
  };

  async createTask(invalidForm: boolean | null) {
    this.creationSuccessful = true;
    const url = environment.baseUrl + '/tasks/';

    await lastValueFrom(this.http.post(url, this.newTask));
