...
import { MenuMenuComponent } from '@scrumapp/menu/menu';
import { ImageFilter, Solver } from '@scrumapp/environments/imagefilter';
import { CommonModule } from '@angular/common';

@Component({
  standalone: true,
  imports: [CommonModule, RouterModule, MenuMenuComponent, RouterModule],
  selector: 'scrumapp-root',
